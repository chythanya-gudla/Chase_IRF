    ...
    public partial class Home : System.Web.UI.Page
    {
        ...
        private void GenerateTable(DataTable dt)
        {
            ...
            tablestring = tablestring +
                 "<table class='table table-striped table-hover' id='ordersTable'><thead><tr><th>Item</th><th>Description</th><th>Item Purpose</th><th>Status</th><th>Item Owner</th><th>Cost Center</th><th>OneBox Month/Yr</th><th>Submitted Date</th><th>Purchase Order</th><th>Action</th></tr></thead><tfoot><tr><th>Item</th><th>Description</th><th>Item Purpose</th><th>Status</th><th>Item Owner</th><th>Cost Center</th><th>OneBox Month/Yr</th><th>Submitted Date</th><th>Purchase Order</th><th>Action</th></tr></tfoot><tbody>";
