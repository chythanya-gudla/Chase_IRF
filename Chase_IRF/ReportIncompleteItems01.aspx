<%@ Page Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="ReportIncompleteItems01.aspx.cs" Inherits="Chase_IRF.ReportIncompleteItems01" %>
...
<link href="https://ajax.aspnetcdn.com/ajax/jquery.ui/1.9.2/themes/blitzer/jquery-ui.css"   rel="Stylesheet" type="text/css" />
    ...
    <%--<form data-toggle="validator" id="reportform" role="form" enctype="multipart/form-data" runat="server" style="max-width:600px">--%>
            ...
            <div class="container"id="reportListDiv" style="height: 968px">
               <div class="newIrf-wrap" style="width: 126%; max-width: 1600px; overflow : scroll;margin-left:-12%;max-height:860px;">
